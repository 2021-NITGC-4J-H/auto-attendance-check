...
class ReferenceAttendFrame(tk.Frame):
    ...
    def __init__(self, new_window: tk.Toplevel):
        ...
        self.chose_subject = ttk.Combobox(self.frame_chose, height=8, width=30, values=self.subjects, font=("Times", 14))
    ...
    def show_data(self, subject: str):
        ...
        # treeviewの作成
        self.column = ("num", "name", "attend", "absent", "late", "authorized absence", "none", "error")
        ...
        try:
            ...
            sftp_connection.get(f"/home/pi/aac/attend_data/json/{subject}.json", f"attend_data/{subject}.json")
